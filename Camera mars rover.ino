...
<html>
  ...
  <body class="noselect" align="center" style="background-color:orange">
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr/><tr/>
      <tr>
        <td style="text-align:left"><b>Rover Speed:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="255" value="90" class="slider" id="Speed" oninput='sendButtonInput("Speed",value)'>
          </div>
        </td>
      </tr>        
      <tr>
        <td style="text-align:left"><b>Camera Light:</b></td>
        <td colspan=2>
          <div class="slidecontainer">
      ...
      <tr>
        <td style="text-align:left"><b>Front servo:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
      ...
      <tr>
        <td style="text-align:left"><b>Back servo:</b></td>
        <td colspan=2>
          <div class="slidecontainer">
